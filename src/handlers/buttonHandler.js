...
module.exports = async (client, interaction) => {
  ...
  if (interaction.customId.startsWith("DiscordNotification")) {
    const ids = JSON.parse(
      interaction.customId.replace("DiscordNotification", ""),
    );
    ...
    if (rustplus)
      rustplus.notificationSettings[ids.setting].discord = setting.discord;
    ...
    const ids = JSON.parse(
      interaction.customId.replace("InGameNotification", ""),
    );
    const setting = instance.notificationSettings[ids.setting];
    ...
    if (rustplus)
      rustplus.notificationSettings[ids.setting].inGame = setting.inGame;
    ...
    const ids = JSON.parse(
      interaction.customId.replace("VoiceNotification", ""),
    );
    const setting = instance.notificationSettings[ids.setting];
    ...
    if (rustplus)
      rustplus.notificationSettings[ids.setting].voice = setting.voice;
    ...
    if (rustplus)
      rustplus.generalSettings.inGameCommandsEnabled =
        instance.generalSettings.inGameCommandsEnabled;
    ...
    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getInGameCommandsEnabledButton(
          guildId,
          instance.generalSettings.inGameCommandsEnabled,
        ),
      ],
    ...
    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getBotMutedInGameButton(
          guildId,
          instance.generalSettings.muteInGameBotMessages,
        ),
      ],
    ...
    if (rustplus)
      rustplus.generalSettings.connectionNotify =
        instance.generalSettings.connectionNotify;
    ...
    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getInGameTeammateNotificationsButtons(guildId),
      ],
    });
    ...
    if (rustplus)
      rustplus.generalSettings.deathNotify =
        instance.generalSettings.deathNotify;
    ...
    if (rustplus)
      rustplus.generalSettings.fcmAlarmNotificationEnabled =
        instance.generalSettings.fcmAlarmNotificationEnabled;
    ...
    if (rustplus)
      rustplus.generalSettings.smartAlarmNotifyInGame =
        instance.generalSettings.smartAlarmNotifyInGame;
    ...
    interaction.customId === "SmartSwitchNotifyInGameWhenChangedFromDiscord"
  ) {
      ...
      components: [
        DiscordButtons.getSmartSwitchNotifyInGameWhenChangedFromDiscordButton(
          ...
          instance.generalSettings
            .smartSwitchNotifyInGameWhenChangedFromDiscord,
        ),
      ],
    });
  } else if (interaction.customId === "AlarmVoiceEnabled") {
    instance.generalSettings.alarmVoiceEnabled =
      !instance.generalSettings.alarmVoiceEnabled;
    client.setInstance(guildId, instance);

    if (rustplus)
      rustplus.generalSettings.alarmVoiceEnabled =
        instance.generalSettings.alarmVoiceEnabled;
    ...
    client.log(
      ...
      client.intlGet(null, "buttonValueChange", {
        id: `${verifyId}`,
        value: `${instance.generalSettings.alarmVoiceEnabled}`,
      }),
    );

    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getAlarmVoiceEnabledButton(
          guildId,
          instance.generalSettings.alarmVoiceEnabled,
        ),
      ],
    ...
    if (rustplus)
      rustplus.generalSettings.leaderCommandEnabled =
        instance.generalSettings.leaderCommandEnabled;
    ...
    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getLeaderCommandEnabledButton(
          guildId,
          instance.generalSettings.leaderCommandEnabled,
        ),
      ],
    ...
    if (rustplus)
      rustplus.generalSettings.mapWipeNotifyEveryone =
        instance.generalSettings.mapWipeNotifyEveryone;
    ...
    await client.interactionUpdate(interaction, {
      components: [
        DiscordButtons.getMapWipeNotifyEveryoneButton(
          instance.generalSettings.mapWipeNotifyEveryone,
        ),
      ],
    });
    ...
    interaction.customId === "DisplayInformationBattlemetricsAllOnlinePlayers"
  ) {
    ...
    await client.interactionUpdate(interaction, {
      components:
        DiscordButtons.getSubscribeToChangesBattlemetricsButtons(guildId),
    });
    ...
    if (rustplus)
      rustplus.generalSettings.battlemetricsGlobalLogin =
        instance.generalSettings.battlemetricsGlobalLogin;
    ...
    if (rustplus)
      rustplus.generalSettings.battlemetricsGlobalLogout =
        instance.generalSettings.battlemetricsGlobalLogout;
    ...
    if (instance.activeServer !== null) {
      await DiscordMessages.sendServerMessage(
        guildId,
    ...
    const ids = JSON.parse(
      interaction.customId.replace("DeleteUnreachableDevices", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    for (const [entityId, content] of Object.entries(server.switches)) {
      if (!content.reachable) {
        ...
        for (const [groupId, groupContent] of Object.entries(
          server.switchGroups,
        )) {
          if (
            groupContent.switches.includes(`${entityId}`) &&
            !groupsToUpdate.includes(groupId)
          ) {
    ...
    const ids = JSON.parse(
      interaction.customId.replace("CustomTimersEdit", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    if (
      Config.discord.needAdminPrivileges &&
      !client.isAdministrator(interaction)
    ) {
      interaction.deferUpdate();
      return;
    }
    ...
    if (
      rustplus &&
      (rustplus.serverId === ids.serverId ||
        rustplus.serverId === instance.activeServer)
    ) {
      await DiscordTools.clearTextChannel(
        rustplus.guildId,
        instance.channelId.switches,
        100,
      );
    ...
    interaction.customId.startsWith("SmartSwitchOn") ||
    interaction.customId.startsWith("SmartSwitchOff")
  ) {
    const ids = JSON.parse(
      interaction.customId
        .replace("SmartSwitchOn", "")
        .replace("SmartSwitchOff", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const active = interaction.customId.startsWith("SmartSwitchOn")
      ? true
      : false;
    ...
    if (!(await rustplus.isResponseValid(response))) {
      if (server.switches[ids.entityId].reachable) {
        await DiscordMessages.sendSmartSwitchNotFoundMessage(
          guildId,
          ids.serverId,
          ids.entityId,
        );
    ...
    if (
      ...
      const str = client.intlGet(
        guildId,
        "userTurnedOnOffSmartSwitchFromDiscord",
        {
          user: user,
          name: name,
          status: status,
    ...
    DiscordMessages.sendSmartSwitchMessage(
      guildId,
      ids.serverId,
      ids.entityId,
      interaction,
    ...
    const modal = DiscordModals.getSmartSwitchEditModal(
      guildId,
      ids.serverId,
      ids.entityId,
    );
    ...
    const ids = JSON.parse(
      interaction.customId.replace("SmartSwitchDelete", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const ids = JSON.parse(
      interaction.customId.replace("SmartAlarmEveryone", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    server.alarms[ids.entityId].everyone =
      !server.alarms[ids.entityId].everyone;
    client.setInstance(guildId, instance);
    ...
    await DiscordMessages.sendSmartAlarmMessage(
      guildId,
      ids.serverId,
      ids.entityId,
      interaction,
    ...
    const ids = JSON.parse(
      interaction.customId.replace("SmartAlarmDelete", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const modal = DiscordModals.getSmartAlarmEditModal(
      guildId,
      ids.serverId,
      ids.entityId,
    );
    ...
    interaction.customId.startsWith("StorageMonitorToolCupboardEveryone")
  ) {
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorToolCupboardEveryone", ""),
    );
    const server = instance.serverList[ids.serverId];

    if (
      !server ||
      (server && !server.storageMonitors.hasOwnProperty(ids.entityId))
    ) {
      await interaction.message.delete();
      return;
    }

    server.storageMonitors[ids.entityId].everyone =
      !server.storageMonitors[ids.entityId].everyone;
    client.setInstance(guildId, instance);
    ...
    interaction.customId.startsWith("StorageMonitorToolCupboardInGame")
  ) {
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorToolCupboardInGame", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    server.storageMonitors[ids.entityId].inGame =
      !server.storageMonitors[ids.entityId].inGame;
    client.setInstance(guildId, instance);
    ...
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorEdit", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const modal = DiscordModals.getStorageMonitorEditModal(
      guildId,
      ids.serverId,
      ids.entityId,
    );
    ...
    interaction.customId.startsWith("StorageMonitorToolCupboardDelete")
  ) {
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorToolCupboardDelete", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorRecycle", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    if (!(await rustplus.isResponseValid(entityInfo))) {
      if (server.storageMonitors[ids.entityId].reachable) {
        await DiscordMessages.sendStorageMonitorNotFoundMessage(
          guildId,
          ids.serverId,
          ids.entityId,
        );
    ...
    const items = client.rustlabs.getRecycleDataFromArray(
      entityInfo.entityInfo.payload.items,
    );
    ...
    const ids = JSON.parse(
      interaction.customId.replace("StorageMonitorContainerDelete", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    interaction.customId.startsWith("GroupTurnOn") ||
    interaction.customId.startsWith("GroupTurnOff")
  ) {
    const ids = JSON.parse(
      interaction.customId
        .replace("GroupTurnOn", "")
        .replace("GroupTurnOff", ""),
    );
    const server = instance.serverList[ids.serverId];

    if (
      !server ||
      (server && !server.switchGroups.hasOwnProperty(ids.groupId))
    ) {
      await interaction.message.delete();
      return;
    }
    ...
    if (rustplus) {
      ...
      if (rustplus.serverId === ids.serverId) {
        const active = interaction.customId.startsWith("GroupTurnOn")
          ? true
          : false;
    ...
    const modal = DiscordModals.getGroupEditModal(
      guildId,
      ids.serverId,
      ids.groupId,
    );
    ...
    const modal = DiscordModals.getGroupAddSwitchModal(
      guildId,
      ids.serverId,
      ids.groupId,
    );
    ...
    const ids = JSON.parse(
      interaction.customId.replace("GroupRemoveSwitch", ""),
    );
    const server = instance.serverList[ids.serverId];
    ...
    const modal = DiscordModals.getGroupRemoveSwitchModal(
      guildId,
      ids.serverId,
      ids.groupId,
    );
    ...
    await DiscordMessages.sendTrackerMessage(
      guildId,
      ids.trackerId,
      interaction,
    );
    ...
    const ids = JSON.parse(
      interaction.customId.replace("TrackerAddPlayer", ""),
    );
    const tracker = instance.trackers[ids.trackerId];
    ...
    const modal = DiscordModals.getTrackerAddPlayerModal(
      guildId,
      ids.trackerId,
    );
    await interaction.showModal(modal);
    ...
    const ids = JSON.parse(
      interaction.customId.replace("TrackerRemovePlayer", ""),
    );
    const tracker = instance.trackers[ids.trackerId];
