...
module.exports = {
  ...
  getServerButtons: function (guildId, serverId, state = null) {
    ...
    if (state === null) {
      if (
        ...
        Client.client.activeRustplusInstances[guildId]
      ) {
        state = 1;
      } else {
        state = 0;
  ...
  getNotificationButtons: function (
    guildId,
    setting,
    discordActive,
    inGameActive,
  ...
  getSmartSwitchNotifyInGameWhenChangedFromDiscordButton: function (
    guildId,
    enabled,
  ) {
    return new Discord.ActionRowBuilder().addComponents(
  ...
  getAlarmVoiceEnabledButton: function (guildId, enabled) {
    return new Discord.ActionRowBuilder().addComponents(
      module.exports.getButton({
        customId: "AlarmVoiceEnabled",
        label: enabled
          ? Client.client.intlGet(guildId, "enabledCap")
          : Client.client.intlGet(guildId, "disabledCap"),
        style: enabled ? SUCCESS : DANGER,
  ...
  getDisplayInformationBattlemetricsAllOnlinePlayersButton: function (
    guildId,
    enabled,
  ) {
    return new Discord.ActionRowBuilder().addComponents(
    ...
    return [
      new Discord.ActionRowBuilder().addComponents(
        module.exports.getButton({
          ...
          label: Client.client.intlGet(
            guildId,
            "battlemetricsServerNameChangesCap",
          ),
          style: instance.generalSettings.battlemetricsServerNameChanges
            ? SUCCESS
            : DANGER,
        }),
        module.exports.getButton({
          ...
          label: Client.client.intlGet(
            guildId,
            "battlemetricsTrackerNameChangesCap",
          ),
          style: instance.generalSettings.battlemetricsTrackerNameChanges
            ? SUCCESS
            : DANGER,
        }),
        module.exports.getButton({
          ...
          label: Client.client.intlGet(
            guildId,
            "battlemetricsGlobalNameChangesCap",
          ),
          style: instance.generalSettings.battlemetricsGlobalNameChanges
            ? SUCCESS
            : DANGER,
        }),
      ),
      new Discord.ActionRowBuilder().addComponents(
        module.exports.getButton({
          ...
          style: instance.generalSettings.battlemetricsGlobalLogin
            ? SUCCESS
            : DANGER,
        }),
        module.exports.getButton({
          ...
          style: instance.generalSettings.battlemetricsGlobalLogout
            ? SUCCESS
            : DANGER,
        }),
      ),
