...
async function setupGeneralSettings(client, guildId, channel) {
  ...
  await client.messageSend(channel, {
    ...
    components: [
      DiscordSelectMenus.getLanguageSelectMenu(
        guildId,
        instance.generalSettings.language,
      ),
    ],
    files: [
      new Discord.AttachmentBuilder(
  ...
  await client.messageSend(channel, {
    ...
    components: [
      DiscordSelectMenus.getVoiceGenderSelectMenu(
        guildId,
        instance.generalSettings.voiceGender,
      ),
    ],
    files: [
      new Discord.AttachmentBuilder(
  ...
  await client.messageSend(channel, {
    ...
    components: [
      DiscordSelectMenus.getPrefixSelectMenu(
        guildId,
  ...
  await client.messageSend(channel, {
    ...
    components: [
      DiscordSelectMenus.getTrademarkSelectMenu(
        guildId,
  ...
  await client.messageSend(channel, {
    ...
    components: [
      DiscordSelectMenus.getCommandDelaySelectMenu(
        guildId,
        instance.generalSettings.commandDelay,
      ),
    ],
    files: [
      new Discord.AttachmentBuilder(
  ...
  await client.messageSend(channel, {
    embeds: [
      DiscordEmbeds.getEmbed({
        ...
        title: client.intlGet(
          guildId,
          "shouldSmartSwitchNotifyInGameWhenChangedFromDiscord",
        ),
        thumbnail: `attachment://settings_logo.png`,
      }),
    ],
  ...
  await client.messageSend(channel, {
    embeds: [
      DiscordEmbeds.getEmbed({
        color: Constants.COLOR_SETTINGS,
        title: client.intlGet(guildId, "shouldAlarmVoiceEnabledSetting"),
        thumbnail: `attachment://settings_logo.png`,
      }),
    ],
    components: [
  ...
  await client.messageSend(channel, {
    embeds: [
      DiscordEmbeds.getEmbed({
        color: Constants.COLOR_SETTINGS,
        title: client.intlGet(guildId, "mapWipeDetectedNotifySetting", {
          group: "@everyone",
        }),
        thumbnail: `attachment://settings_logo.png`,
      }),
