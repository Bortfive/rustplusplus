...
module.exports = {
  sendMessage: async function (
    ...
    if (!channel) {
      Client.client.log(
        ...
        Client.client.intlGet(null, "couldNotGetChannelWithId", {
          id: channelId,
        }),
        "error",
      );
  ...
  sendServerMessage: async function (
    guildId,
    serverId,
    state = null,
    interaction = null,
  ...
  sendSmartSwitchMessage: async function (
    guildId,
    serverId,
    entityId,
    interaction = null,
    ...
    const content = {
      embeds: [
        entity.reachable
          ...
          : DiscordEmbeds.getNotFoundSmartDeviceEmbed(
              guildId,
              serverId,
              entityId,
              "switches",
      ...
      components: [
        DiscordSelectMenus.getSmartSwitchSelectMenu(
          guildId,
          serverId,
          entityId,
        ),
      ...
      files: [
        new Discord.AttachmentBuilder(
          Path.join(
            __dirname,
            "..",
            `resources/images/electrics/${entity.image}`,
          ),
        ),
      ],
    };
  ...
  sendSmartAlarmMessage: async function (
    guildId,
    serverId,
    entityId,
    interaction = null,
  ...
  sendStorageMonitorMessage: async function (
    guildId,
    serverId,
    entityId,
    interaction = null,
    ...
    const content = {
      ...
      components: [
        entity.type === "toolCupboard"
          ...
          : DiscordButtons.getStorageMonitorContainerButton(
              guildId,
              serverId,
              entityId,
            ),
  ...
  sendSmartSwitchGroupMessage: async function (
    guildId,
    serverId,
    groupId,
    interaction = null,
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getSmartSwitchGroupEmbed(guildId, serverId, groupId),
      ],
      components: DiscordButtons.getSmartSwitchGroupButtons(
        guildId,
        serverId,
        groupId,
      ),
      files: [
        new Discord.AttachmentBuilder(
          Path.join(
            __dirname,
            "..",
            `resources/images/electrics/${group.image}`,
          ),
        ),
      ],
    };
  ...
  sendStorageMonitorRecycleMessage: async function (
    guildId,
    serverId,
    entityId,
    items,
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getStorageMonitorRecycleEmbed(
          guildId,
          serverId,
          entityId,
          items,
  ...
  sendDecayingNotificationMessage: async function (
    guildId,
    serverId,
    entityId,
  ) {
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getDecayingNotificationEmbed(guildId, serverId, entityId),
      ],
      files: [
        new Discord.AttachmentBuilder(
          Path.join(
  ...
  sendStorageMonitorDisconnectNotificationMessage: async function (
    guildId,
    serverId,
    entityId,
  ) {
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getStorageMonitorDisconnectNotificationEmbed(
          guildId,
          serverId,
          entityId,
        ),
  ...
  sendStorageMonitorNotFoundMessage: async function (
    guildId,
    serverId,
    entityId,
  ) {
    ...
    const content = {
      embeds: [
        await DiscordEmbeds.getStorageMonitorNotFoundEmbed(
          guildId,
          serverId,
          entityId,
        ),
  ...
  sendSmartSwitchNotFoundMessage: async function (guildId, serverId, entityId) {
    ...
    const content = {
      embeds: [
        await DiscordEmbeds.getSmartSwitchNotFoundEmbed(
          guildId,
          serverId,
          entityId,
        ),
  ...
  sendSmartAlarmNotFoundMessage: async function (guildId, serverId, entityId) {
    ...
    const content = {
      embeds: [
        await DiscordEmbeds.getSmartAlarmNotFoundEmbed(
          guildId,
          serverId,
          entityId,
        ),
  ...
  sendServerChangeStateMessage: async function (guildId, serverId, state) {
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getServerChangedStateEmbed(guildId, serverId, state),
      ],
    };
  ...
  sendServerWipeDetectedMessage: async function (guildId, serverId) {
    ...
    const content = {
      ...
      content: instance.generalSettings.mapWipeNotifyEveryone
        ? "@everyone"
        : "",
    };
  ...
  sendServerConnectionInvalidMessage: async function (guildId, serverId) {
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getServerConnectionInvalidEmbed(guildId, serverId),
      ],
    };
  ...
  sendDiscordEventMessage: async function (
    guildId,
    serverId,
    text,
    image,
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getEventEmbed(guildId, serverId, text, image, color),
      ],
      files: [
        new Discord.AttachmentBuilder(
  ...
  sendTTSMessage: async function (guildId, name, text) {
    ...
    const content = {
      content: Client.client.intlGet(guildId, "userSaid", {
        user: name,
        text: text,
      }),
      tts: true,
      ...
      files: [
        new Discord.AttachmentBuilder(
          Path.join(
            ...
            "..",
            "..",
            `maps/${rustplus.guildId}_map_full.png`,
          ),
        ),
      ],
    };
  ...
  sendUpdateBattlemetricsOnlinePlayersInformationMessage: async function (
    rustplus,
    battlemetricsId,
  ) {
    const instance = Client.client.getInstance(rustplus.guildId);
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getUpdateBattlemetricsOnlinePlayersInformationEmbed(
          rustplus,
          battlemetricsId,
        ),
      ],
    ...
    if (
      message &&
      message.id !== instance.informationMessageId.battlemetricsPlayers
    ) {
  ...
  sendDiscordCommandResponseMessage: async function (
    rustplus,
    client,
    message,
    response,
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getDiscordCommandResponseEmbed(rustplus, response),
      ],
    };
  ...
  sendCredentialsShowMessage: async function (interaction) {
    const content = {
      embeds: [
        await DiscordEmbeds.getCredentialsShowEmbed(interaction.guildId),
      ],
      ephemeral: true,
    };
  ...
  sendItemAvailableInVendingMachineMessage: async function (rustplus, str) {
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getItemAvailableVendingMachineEmbed(
          rustplus.guildId,
          rustplus.serverId,
          str,
        ),
  ...
  sendResearchMessage: async function (interaction, researchDetails) {
    const content = {
      embeds: [
        DiscordEmbeds.getResearchEmbed(interaction.guildId, researchDetails),
      ],
      ephemeral: true,
    };
  ...
  sendRecycleMessage: async function (
    interaction,
    recycleDetails,
    quantity,
    recyclerType,
  ...
  sendBattlemetricsEventMessage: async function (
    ...
    const content = {
      embeds: [
        DiscordEmbeds.getBattlemetricsEventEmbed(
          guildId,
          battlemetricsId,
          title,
          description,
  ...
  sendItemMessage: async function (interaction, itemName, itemId, type) {
    const content = {
      embeds: [
        DiscordEmbeds.getItemEmbed(interaction.guildId, itemName, itemId, type),
      ],
      ephemeral: true,
    };
